					...
					<div id="main">
						...
						<!-- PostN -->
							<article class="post special">
								<h1>關於站主</h1>
								<span class="image middle"><img src="images/avatar.png" /></span>
								<p>
								一位外表看似平凡，實際上也是平凡無奇的男孩<br/>
								興趣廣泛，喜歡羽球、桌球、小說、戲劇、漫畫...<br/>
								對什麼都感興趣，但又總是三分鐘熱度<br/>
								</p>
								<p>
								自認姑且算是個精靈寶可夢（神奇寶貝）達人<br/>
								座右銘是「盡人事，聽天命」<br/>
