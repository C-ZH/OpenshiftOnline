...
<title>【Day 131】 再次能樂鑑賞 | 京都の留學日誌</title>
					...
					<div id="main">
						...
						<!-- Post -->
							<article class="post">
								...
								<!-- Content START -->
								<span class="image featured"><img src="../images/cover/article_68_cover.jpg" alt="" /></span>
								<p>今天又為了能樂課的報告去看表演，老實說很後悔修這門課啊QQ 花費的時間比當初預想的多太多了。</p>
								<p>不過也遇到好事，那就是人生中第一次看到積雪!!! 宿舍所在的下京這一帶都沒什麼雪，但一到東山就看到不少雪，雖然只有薄薄一層，但地上確實地鋪滿了雪，葉子上的薄雪也很漂亮！還看到有人在自掃門前雪XD</p>
								<span class="image left_2"><img src="../images/article_img/article_68_snow1.jpg" alt="" /></span>
								<span class="image left_2"><img src="../images/article_img/article_68_snow2.jpg" alt="" /></span>
								<span class="image left_2"><img src="../images/article_img/article_68_snow3.jpg" alt="" /></span>
								<span class="image left_2"><img src="../images/article_img/article_68_snow4.jpg" alt="" /></span>
								<p>照慣例，我聽了半場就走了，不過感覺有比之前還聽得懂表演者在幹嘛了。<br/>
								結束後，走去業務超市買晚餐要做「日式乾咖哩」的材料。路過一個伊藤園的販賣機，看到之前在嵐山見過的，有寶可夢果菜汁的販賣機，立刻投了一枚 100 圓進去。沒想到，中了！是噴火龍啊!!! 爽！</p>
								<span class="image middle"><img src="../images/article_img/article_68_rizadon.jpg" alt="" /></span>
								<p>晚餐的乾咖哩因為要把所有材料都切丁，備料很花時間，但做出來的成果很滿意，應該是我來日本後所做出最好吃的料理了！</p>
								<span class="image left_2"><img src="../images/article_img/article_68_curry1.jpg" alt="" /></span>
								<span class="image left_2"><img src="../images/article_img/article_68_curry2.jpg" alt="" /></span>
								<!-- Content END -->
								<%
								...
								<!-- FB Comment -->
								<h2>以 Facebook 留言</h2>
								<div class="fb-comments" data-href="http://kyotoexchange-env.qe72ehkehh.ap-northeast-1.elasticbeanstalk.com/article/article_68.jsp" data-numposts="5"></div>
