...
<title>【Day 33】京友禪體驗活動 | 京都の留學日誌</title>
					...
					<div id="main">
						...
						<!-- Post -->
							<article class="post">
								<header>
									<div class="title">
										<h2>【Day 33】京友禪體驗活動</h2>
									</div>
									<div class="meta">
										<time class="published" datetime="2017-10-08">2017年10月8日</time>
									</div>
								</header>
								<!-- Content START -->
								<span class="image featured"><img src="../images/cover/article_16_cover.jpg" alt="" /></span>
								<p>之前報名了不少留學生課舉辨的文化體驗活動，很幸運地幾乎都被抽中！首先登場的是這個京友禪體驗。<br/>
								京友禪是什麼呢？簡單來說是一種染布的方式，名稱來自於一位名叫「友禪」的染布師。和客家的藍染不太一樣，比較像是在布上畫圖。</p>
								<span class="image left_3"><img src="../images/article_img/article_16_bottle1.JPG" /></span>
								<span class="image left_3"><img src="../images/article_img/article_16_bottle2.JPG" /></span>
								<span class="image left_3"><img src="../images/article_img/article_16_bottle3.JPG" /></span>
								<p>真的很神奇，像我這種美術白癡，照著指示畫也還不錯看耶！雖然狐狸的眼睛不見了。</p>
								<p>在這個活動中，終於和台大唯二的另一位交換生見面了！然後活動結束後，和他、來自香港的朋友與師大的同學，以及一位長相很不日本人的日本人A同學一起去吃午餐。</p>
								<span class="image fit"><img src="../images/article_img/article_16_lunch.JPG" /></span>
								<p>走了一段時間後，我們決定去吃迴轉壽司。人生第一次吃迴轉壽司耶！<br/>
								因為沒在台灣吃過，所以也無法比較兩地的差異XD 但吃完後的感想是：嗯，我果然對生魚片無感。覺得最好吃的居然是玉子燒壽司… 然後聽師大同學說友藏最愛吃的鯖魚超難吃，有股酸味且肉質像是橡膠，害我完全不敢拿XD</p>
								<span class="image left_3"><img src="../images/article_img/article_16_sushi1.JPG" />（鮭魚）</span>
								<span class="image left_3"><img src="../images/article_img/article_16_sushi2.JPG" />（鮭魚卵，比想像中難吃）</span>
								<span class="image left_3"><img src="../images/article_img/article_16_sushi3.JPG" />（其實吃起來以日本的外食而言不貴）</span>
								<p>這種留學生課辦的活動還滿有趣的！下星期也有報名到，要體驗製作聽說吃過的人都說不好吃的京都特產「生八橋」。</p>
								<!-- Content END -->
								<%
								...
								<!-- FB Comment -->
								<h2>以 Facebook 留言</h2>
								<div class="fb-comments" data-href="http://kyotoexchange-env.qe72ehkehh.ap-northeast-1.elasticbeanstalk.com/article/article_16.jsp" data-numposts="5"></div>
