					...
					<div id="main">
						...
						<!-- Post -->
							<article class="post">
								...
								<!-- Content START -->
								<span class="image featured"><img src="../../images/recipe_img/recipe_69_cover.jpg" alt="" /></span>
								<p>【參考教學】<br/>
								我的腦
								</p>
								...
								<span>【作法】</span>
								<ol>
									<li>香菇切片備用，太白粉加水做成太白水拌勻。</li>
									<li>水大火煮滾。</li>
									<li>熄火，加入湯包拌勻。</li>
									<li>中小火煮到滾，加入玉米和香菇，再加鹽調味。</li>
									<li>雞蛋打散，加到湯裡做蛋花。</li>
									<li>熄火，加太白水拌勻完成。</li>
								</ol>

								<p>【感想】<br/>
								好喝！這次勾芡用得剛剛好，然後感覺加一點奶油會更好喝。
								</p>
								<!-- Content END -->
								
								<!-- FB Comment -->
								<h2>以 Facebook 留言</h2>
								<div class="fb-comments" data-href="http://kyotoexchange-env.qe72ehkehh.ap-northeast-1.elasticbeanstalk.com/article/recipe/recipe_69.jsp" data-numposts="5"></div>
								</div>
							</article>
					</div>
