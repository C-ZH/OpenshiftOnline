					...
					<div id="main">
						...
						<!-- Post -->
							<article class="post">
								...
								<!-- Content START -->
								<span class="image featured"><img src="../../images/recipe_img/recipe_56_cover.jpg" alt="" /></span>
								<p>【參考教學】<br/>
								我的腦
								</p>
								...
								<ol>
									<li>平底鍋放油中小火熱鍋。</li>
									<li>洋蔥切條備用。雞蛋加鹽打勻。</li>
									<li>倒入蛋液於平底鍋，然後快速攪拌成散蛋。</li>
									<li>放入洋蔥，轉中火炒。</li>
									<li>快好時加入鹽，再稍微炒一下後起鍋。</li>
								</ol>
								<p>【感想】<br/>
								其實之前做過一次，但太失敗了，被我當成黑歷史處理。
								</p>
								<!-- Content END -->
								
								<!-- FB Comment -->
								<h2>以 Facebook 留言</h2>
								<div class="fb-comments" data-href="http://kyotoexchange-env.qe72ehkehh.ap-northeast-1.elasticbeanstalk.com/article/recipe/recipe_56.jsp" data-numposts="5"></div>
								</div>
							</article>
					</div>
