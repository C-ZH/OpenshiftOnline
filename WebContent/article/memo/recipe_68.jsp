...
<title>【食譜】香菇炒紅蘿蔔白菜 | 京都の留學日誌</title>
						...
						<!-- Post -->
							<article class="post">
								<header>
									...
									<div class="meta">
										<time class="published" datetime="2018-02-04">2018年2月4日</time>
									</div>
								</header>
								<!-- Content START -->
								<span class="image featured"><img src="../../images/recipe_img/recipe_68_cover.jpg" alt="" /></span>
								<p>【參考教學】<br/>
								我的腦
								</p>
								...
								<span>【作法】</span>
								<ol>
									<li>薑切絲，紅蘿蔔切絲，香菇、白菜切片備用。</li>
									<li>加油中小火熱鍋，薑絲爆香。</li>
									<li>轉中火，依次放入紅蘿蔔、香菇、白菜炒。</li>
									<li>加鹽調味，在炒一下起鍋。</li>
								</ol>
								...
								<!-- FB Comment -->
								<h2>以 Facebook 留言</h2>
								<div class="fb-comments" data-href="http://kyotoexchange-env.qe72ehkehh.ap-northeast-1.elasticbeanstalk.com/article/recipe/recipe_68.jsp" data-numposts="5"></div>
								</div>
							</article>
					</div>
