					...
					<div id="main">
						...
						<!-- Post -->
							<article class="post">
								...
								<!-- Content START -->
								<span class="image featured"><img src="../../images/recipe_img/recipe_08_cover.jpg" alt="" /></span>
								<p>【參考教學】<br/>
								我的腦
								</p>
								...
								<p>【感想】<br/>
								拿平底鍋乾煎感覺就和烤吐司機的原理差不多。
								</p>
								<!-- Content END -->
								
								<!-- FB Comment -->
								<h2>以 Facebook 留言</h2>
								<div class="fb-comments" data-href="http://kyotoexchange-env.qe72ehkehh.ap-northeast-1.elasticbeanstalk.com/article/recipe/recipe_08.jsp" data-numposts="5"></div>
								</div>
							</article>
					</div>
