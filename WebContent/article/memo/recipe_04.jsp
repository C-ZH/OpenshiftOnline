					...
					<div id="main">
						...
						<!-- Post -->
							<article class="post">
								...
								<!-- Content START -->
								<span class="image featured"><img src="../../images/recipe_img/recipe_04_cover.jpg" alt="" /></span>
								<p>【參考教學】<br/>
								我的腦
								</p>
								...
								<p>
									<u>
									※1 這種菜我在台灣完全沒聽過，日本倒是很多。其實其他青菜也可啦，我之後也有用一樣的方式炒青江菜。<br/>
									※2 也可不加，或是加醬油膏之類的。
									</u>
								</p>
								<p>【感想】<br/>
								...
								<!-- FB Comment -->
								<h2>以 Facebook 留言</h2>
								<div class="fb-comments" data-href="http://kyotoexchange-env.qe72ehkehh.ap-northeast-1.elasticbeanstalk.com/article/recipe/recipe_04.jsp" data-numposts="5"></div>
								</div>
							</article>
					</div>
