...
<title>【食譜】過年蕎麥麵（年越しそば） | 京都の留學日誌</title>
					...
					<div id="main">
						...
						<!-- Post -->
							<article class="post">
								...
								<p>【參考教學】<br/>
								<a href="https://cookpad.com/recipe/4833838" class="ref" target="_blank">年越し蕎麦にも！簡単蕎麦つゆ</a>
								</p>

								<span>【材料】</span>
								<ul>
									<li>蕎麥麵（そば） ----- 2 捆 <u>※1</u></li>
									<li>蔥花（刻みネギ） ----- 適量</li>
									<li>便利商店買的微波紅燒蝦仁（海老チリ） ----- 1 袋 <u>※2</u></li>
									<li>高湯（だし） ----- 600 ml</li>
									<li>味淋（みりん） ----- 2 大匙</li>
									<li>醬油（醤油） ----- 2 大匙</li>
									<li>料理酒（料理酒） ----- 1 大匙</li>
								...
								<span>【作法】</span>
								<ol>
									<li>把蕎麥麵大火放到裝水的鍋子燙熟後，撈出來泡冷水備用。</li>
									<li>高湯、醬油、味淋、料理酒家到鍋內大火煮沸當湯頭。</li>
									<li>把燙好的麵加進去湯頭中火煮 1 ~ 2 分鐘。</li>
									<li>加蔥花進去。</li>
									<li>撈出來放到碗裡後，把蝦仁擺在麵上。</li>
								</ol>
								
								<p>
									<u>
									※1 我用的麵條是只有 2 成蕎麥粉的便宜貨。<br/>
									※2 買不到炸蝦天婦羅的替代方案，有點貴。
									</u>
								</p>
								<p>【感想】<br/>
								...
								<!-- FB Comment -->
								<h2>以 Facebook 留言</h2>
								<div class="fb-comments" data-href="http://kyotoexchange-env.qe72ehkehh.ap-northeast-1.elasticbeanstalk.com/article/recipe/recipe_51.jsp" data-numposts="5"></div>
								</div>
							</article>
					</div>
