...
<title>【食譜】日式年糕（焼き餅） | 京都の留學日誌</title>
					...
					<div id="main">
						...
						<!-- Post -->
							<article class="post">
								...
								<!-- Content START -->
								<span class="image featured"><img src="../../images/recipe_img/recipe_52_cover.jpg" alt="" /></span>
								<p>【參考教學】<br/>
								我的腦。
								</p>
								...
								<span>【作法】</span>
								<ol>
									<li>在平底鍋上鋪烘焙紙，中火熱鍋。</li>
									<li>鍋子熱了後，把年糕放上去烤。</li>
									<li>烤到差不多後拿出來。</li>
								</ol>

								<p>【感想】<br/>
								很費時間，沒沾醬、粉，或放到湯裡就不好吃。
								</p>
								<!-- Content END -->
								
								<!-- FB Comment -->
								<h2>以 Facebook 留言</h2>
								<div class="fb-comments" data-href="http://kyotoexchange-env.qe72ehkehh.ap-northeast-1.elasticbeanstalk.com/article/recipe/recipe_52.jsp" data-numposts="5"></div>
								</div>
							</article>
					</div>
