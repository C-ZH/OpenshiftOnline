...
<title>【食譜】青椒炒肉絲（チンジャオロース） | 京都の留學日誌</title>
					...
					<div id="main">
						...
						<!-- Post -->
							<article class="post">
								...
								<!-- Content START -->
								<span class="image featured"><img src="../../images/recipe_img/recipe_57_cover.jpg" alt="" /></span>
								<p>【參考教學】<br/>
								《中華一番》動畫第 5 話〈伝統を打ち破れ! 打倒・陽泉酒家〉
								</p>
								...
								<span>【作法】</span>
								<ol>
									<li>青椒、竹筍、雞胸肉切絲備用。 ※2</li>
									<li>平底鍋加油中小火熱鍋。</li>
									<li>蒜頭入鍋爆香。</li>
									<li>加入竹筍拌炒，然後加青椒炒，最後再加肉條下去炒。</li>
									<li>加醬油膏、鹽調味後，再炒一下起鍋。</li>
								</ol>
								...
								<!-- FB Comment -->
								<h2>以 Facebook 留言</h2>
								<div class="fb-comments" data-href="http://kyotoexchange-env.qe72ehkehh.ap-northeast-1.elasticbeanstalk.com/article/recipe/recipe_57.jsp" data-numposts="5"></div>
								</div>
							</article>
					</div>
