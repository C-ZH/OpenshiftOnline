						...
						<!-- Post -->
							<article class="post">
								<header>
									...
									<div class="meta">
										<time class="published" datetime="2017-09-06">2017年9月6日</time>
									</div>
								</header>
								<!-- Content START -->
								<span class="image featured"><img src="../images/cover/article_1_cover.jpg" alt="" /></span>
								<p>和家人在桃園機場待了一個晚上後，就搭著早上 6 點多的飛機來到關西空港。搭乘的是廉航捷星，機上的座位比想像中還小，幸好我還算夠苗條XD<br/>
								在飛機上會要我們填寫入境資料，分別是旅客資料和攜帶物品的資料。下飛機入境後，現場有幾位中文翻譯，拿留學簽證的人會被帶到另一個通道，因此不用和其他觀光客排隊等很久，同時也會製作在留卡，這張卡功用就類似身分證。另外，也會問你有沒有要打工，要的話就會再在留卡背後蓋上一個許可章，有這個章才能打工。<br/>
								到了關空後，我所知道前往京都的方式大致上有 3 種：
								<ul>
									<li>
										<a class="ref" target="_blank" href="http://www.howto-osaka.com/tc/ticket/ticket/kyoto.html">京都 Access Ticket（京都アクセスきっぷ）</a><br/>
										要轉車 2 次，票價非常便宜，乘車時間久，大約 2 小時。
									</li>
									<li>
										<a class="ref" target="_blank" href="http://www.kate.co.jp/tcn/timetable/detail/KY">利木津巴士（リムジンバス）</a><br/>
										直達京都，票價中等，速度中等，大概 100 分鐘。我乘坐的方式。
									</li>
									<li>
										南海電鐵<a class="ref" target="_blank" href="http://www.kate.co.jp/tcn/timetable/detail/KY">「特急 HARUKA（特急はるか）」</a></br/>
										直達京都，票價很貴，速度很快，大約 75 分鐘。若持觀光簽證買「HARUKA &amp; ICOCA 套票」的話很划算，會降到只有 1500 日圓。來觀光大力推薦這個。
									</li>
								</ul>
								依照同志社給的指示：買電話卡打公共電話回報 → 搭往京都車站的利木津巴士 → 從京都車站走路到宿舍。
								<span class="image middle"><img class="" src="../images/article_img/article_1_gate.jpg" /></span>
								</p>
								<p>宿舍剛好就在西本願寺對面。雖然事前有想到這個可能性，但宿舍真的沒有電梯!!!我又被分在最高的5樓，只好扛著行李爬樓梯上樓QQ<br/>
								在男三住習慣 1 樓後，要爬上爬下真的有點麻煩，幸好窗外的景色不錯！
								<span class="image fit"><img class="" src="../images/article_img/article_1_tera.jpg" />
								（剛好住得高，往下可以眺望世界遺產西本願寺）
								</span>
								宿舍內部就是個小套房，有廁所浴室、廚房、小型冰箱、微波爐、書桌檯燈、三層小櫃子等等，整體還算不錯啦，美中不足的是流理台有點小、書桌沒有抽屜、台燈打開時有滋滋滋的聲響，還有地上的毛毯有個奇怪的污漬。雖然房租不算便宜（一個月大約 4 萬日圓），不過水電都不用另外付錢就是棒！</p>
								<p>總之，今天做的事大概就是整理房間。</p>
								<%
								...
								<!-- FB Comment -->
								<h2>以 Facebook 留言</h2>
								<div class="fb-comments" data-href="http://kyotoexchange-env.qe72ehkehh.ap-northeast-1.elasticbeanstalk.com/article/article_1.jsp" data-numposts="5"></div>
