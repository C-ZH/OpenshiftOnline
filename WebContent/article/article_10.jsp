...
<title>【Day 11 ~ 13】颱風天 耍廢天 | 京都の留學日誌</title>
					...
					<div id="main">
						...
						<!-- Post -->
							<article class="post">
								<header>
									<div class="title">
										<h2>【Day 11 ~ 13】颱風天 耍廢天</h2>
									</div>
									<div class="meta">
										<time class="published" datetime="2017-09-18">2017年9月18日</time>
									</div>
								</header>
								<!-- Content START -->
								<span class="image featured"><img src="../images/cover/article_10_cover.jpg" alt="" /></span>
								<p>從昨天有始就感覺有點變冷了，今天早上一看氣溫居然只有 20 度，才九月耶！然後聽說星期日泰利颱風會來。<br/>
								基本上這三天就一起寫好了，也沒發生什麼事，就只是躲颱風、宅在宿舍補網誌這樣。</p>

								<p>星期六下午看到吐司快過期了，就來試著煎個法式吐司好了！參考<a class="ref" target="_blank" href="https://icook.tw/recipes/182955">食譜</a>來做，看照片煎出來感覺還不錯！但事實上下面那片吃下去發現沒煎熟，又拿回去再煎一次XD 是說我還是無法喜歡上法式吐司這種軟軟的口感。</p>
								<p>星期日來日本後第一次炒青菜，雖然沒有大蒜之類的爆香，但比想像中簡單。晚上把帶過來的康寶酸辣湯包煮掉一包，並加上麵變成了酸辣麵，不過麵好像放太多了…</p>
								<span class="image left_3"><img src="../images/article_img/article_10_dinner.jpg" />（炒青菜）</span>
								<span class="image left_3"><img src="../images/article_img/article_10_soup.jpg" />（酸辣湯）</span>
								<span class="image left_3"><img src="../images/article_img/article_10_noddles.jpg" />（酸辣湯麵）</span>
								
								<p>剩下時間就是在補網誌。現在真的有點佩服那些寫一堆文章的部落客，畢竟以前沒玩過無名小站，這次是第一次寫部落格，先不論系統部分的修正與維護，把短短的一篇寫好，完整地組織起來就要花不少時間。光是上線就拖了兩星期，不知道這個部落格會持續寫到什麼時候XD 我個人當然希望越久越好囉！</p>
								<!-- Content END -->
								<%
								...
								<!-- FB Comment -->
								<h2>以 Facebook 留言</h2>
								<div class="fb-comments" data-href="http://kyotoexchange-env.qe72ehkehh.ap-northeast-1.elasticbeanstalk.com/article/article_10.jsp" data-numposts="5"></div>
