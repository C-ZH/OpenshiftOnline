...
<title>【Day 4】開戶小瓶頸 | 京都の留學日誌</title>
						...
						<!-- Post -->
							<article class="post">
								<header>
									...
									<div class="meta">
										<time class="published" datetime="2017-09-09">2017年9月9日</time>
									</div>
								</header>
								<!-- Content START -->
								<span class="image featured"><img src="../images/cover/article_4_cover.jpg" alt="" /></span>
								<p>今天要做兩件事：完成開戶，還有騎去同志社看看環境，順便熟悉一下這台腳踏車。</p>

								<p>開戶我選擇的是東京三菱 UFJ 銀行的線上開戶方案，詳細介紹可以參考<a class="ref" target="_blank" href="http://r53284.pixnet.net/blog/post/323172951-japan-open-account-ufj">這個網站</a>，我和裡面辦理的手續大致相同，唯一不同的是我不是用普通預金方案，而是用「スーパー普通預金［段階金利型］」方案，兩者的差別在於後者會依據你戶頭裡這個月的餘額決定該月可享有的優惠，例如 10 萬以上，用 UFJ 的 ATM 提錢不用手續費（日本一般 ATM 提錢都要扣手續費）；30 萬以上可在便利商店免費提錢 3 次。</p>

								<p>然而，線上申請完後還要去設在銀行內 ATM 旁邊的電視機和服務人員做遠端通訊，並利用即時掃描和電腦輸入完成契約。這個過程我花了 1 ~ 2 小時，除了開戶手續真的蠻多之外，中間有好幾個步驟還出現雞同鴨講的狀況，服務人員感覺也都有點不耐煩和無奈了XD<br/> 
								最後終於辦好了！也順便辦了信用卡，聽說一週後會寄來，然後把一直帶在身上的鉅款存進去。UFJ 特色是有和迪士尼合作，因此存摺和提款卡都可以選要不要用迪士尼圖案。
								</p>

								<p>接著想說去同志社看看好了，整體而言比我想的還小，校內雖然可以停腳踏車，但是不能騎只能用牽引的方式。回程想說測一下到宿舍的時間好了，結果比想像中還遠orz 我用慢速騎大概要 35 分鐘，快一點的話估計也要 25 ~ 30 分鐘吧。
								<span class="image middle"><img src="../images/article_img/article_4_brother.jpg" />（看到這名字第一時間想到某位戰士，還把英文名稱看成 CHICKEN，但其實是因為同志社崇尚陽明心學，很多教學館都用相關理念命名）</span>
								<span class="image middle"><img src="../images/article_img/article_4_coco.jpg" />（這裡居然也有 COCO!!! 其實還不錯吃，但台灣真的賣太貴）</span>
								</p>

								<p>今晚第一次開伙！身為料理白癡的我試著煎了培根和蛋，雖不完美但感覺還OK啦！ 只是蛋黃都會被我戳破，因此不是很美觀。
								<span class="image middle"><img src="../images/article_img/article_4_howardfire.gif" />（原本想煎成這樣）</span>
								<span class="image middle"><img src="../images/article_img/article_4_howard.jpg" />（想當然爾，結果完全不像）</span>
								</p>	
								<!-- Content END -->
								<%
								...
								<!-- FB Comment -->
								<h2>以 Facebook 留言</h2>
								<div class="fb-comments" data-href="http://kyotoexchange-env.qe72ehkehh.ap-northeast-1.elasticbeanstalk.com/article/article_4.jsp" data-numposts="5"></div>
